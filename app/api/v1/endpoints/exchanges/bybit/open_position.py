...
from app.schemas.exchange_trading import BybitOpenPositionRequest


async def open_bybit_position(
    payload: BybitOpenPositionRequest,
    ...
    try:
        return await container.open_bybit_position.execute(
