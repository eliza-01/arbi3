...
from app.schemas.exchange_trading import BinanceOpenPositionRequest


async def open_binance_position(
    payload: BinanceOpenPositionRequest,
    ...
    try:
        return await container.open_binance_position.execute(
